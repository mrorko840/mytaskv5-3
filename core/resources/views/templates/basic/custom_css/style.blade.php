 ...
 */
    ...
    *::after {
    ...
    .bg-primary {
        background-color: #f44511 !important;
    }
    ...
    button.bg-primary:focus {
        background-color: #922706 !important;
    }
    ...
    .bg-success {
        background: var(--bg-gradiant-success) !important;
    }
    ...
    .bg-default-secondary {
        background-color: #ffc107 !important;
        background-image: var(--bg-gradiant-orange);
        color: #ffffff;
    }
    ...
    .bg-default-light {
        background-color: #94c2ee !important;
    }
    ...
    .bg-success-light {
        background-color: #d0f4d8 !important;
    }
    ...
    .shadow-default {
        box-shadow: 0 5px 10px rgb(255 95 0 / 20%) !important;
        -webkit-box-shadow: 0 5px 10px rgb(255 95 0 / 20%) !important;
        -moz-box-shadow: 0 5px 10px rgb(255 95 0 / 20%) !important;
        -ms-box-shadow: 0 5px 10px rgb(255 95 0 / 20%) !important;
    }
    ...
    .header {
        ...
        width: 100%;
        z-index: 99;
        background: var(--bg-gradiant-gold);
        border-radius: 0;
    }
    ...
    .btn-default {
        ...
        background: var(--bg-gradiant-orange);
        color: #ffffff;
    }

    .btn-default:hover,
    .btn-default:focus {
        background: var(--bg-gradiant-orange-alt);
        color: #ffffff;
    }
    ...
    .float-label .form-control:focus.text-white {
    ...
    .float-label .form-control.is-valid {
        border-bottom: 1px solid #28a745;
    }

    .float-label.active .form-control.text-white {
        border-bottom: 1px solid rgba(255, 255, 255, 0.6);
    }
    ...
    /* cart count */
    .cart-count {
        background-color: rgba(54, 41, 183, 0.1);
        color: #d9a300;
        border-radius: 5px;
        padding: 2px;
        width: 66px;
    ...
    .cart-count .input-group-prepend .btn:focus,
    .cart-count .input-group-prepend .btn:active,
    .cart-count .input-group-append .btn:focus,
    .cart-count .input-group-append .btn:active {
        background-color: rgba(54, 41, 183, 0.2);
        box-shadow: none;
        outline: none;
    }
    ...
    .cart-count .form-control.rounded {
        border-radius: 18px;
    }
    ...
    .addsendcarousel .swiper-slide:hover p {
        opacity: 1;
    }
    ...
    /* 14. menu */
    .menu-overlay .main-menu {
        background: var(--bg-gradiant-gold-alt);
        color: #ffffff;
        background-size: cover;
    ...
    .menu-overlay .main-menu .menu-container .nav-pills .nav-item .nav-link span {
        vertical-align: middle;
    }

    .menu-overlay .main-menu .menu-container .nav-pills .nav-item .nav-link .icon {
        margin-right: 10px;
        font-size: 20px;
        width: 24px;
    }
    ...
    .menu-overlay .main-menu>.btn-close {
        margin: 0 auto;
        opacity: 1;
        border-radius: 0;
    }

    .menu-overlay .main-menu+.backdrop {
        display: none;
    }
    ...
    .menu-overlay.menu-open .main-menu+.backdrop {
        display: block;
        height: 100%;
        width: 100%;
        color: #ffffff;
    ...
    .menu-push-content .main-menu .menu-container .nav-pills .nav-item .nav-link span {
        vertical-align: middle;
    }
    ...
    .menu-push-content .main-menu>.close {
        margin: 0 auto;
        opacity: 1;
        border-radius: 0;
    }
    ...
    .darkmode .text-default,
    .darkmode .text-dark,
    .darkmode a {
        color: #e0ddf7 !important;
    }

    .darkmode .bg-white-light {
        background-color: rgba(255, 255, 255, 0.2) !important;
    }

    .darkmode .bg-primary-light {
        background-color: white !important;
    }

    .darkmode .bg-default-light {
        background-color: #2a6c94 !important;
    }

    .darkmode .bg-danger-light {
        background-color: #fae3e5 !important;
    }

    .darkmode .bg-success-light {
        background-color: #d0f4d8 !important;
    }

    .darkmode .bg-warning-light {
        background-color: #fff1c9 !important;
    }
    ...
    .darkmode .footer a:not(.btn).active i,
    .darkmode .footer a:not(.btn).active span {
        color: #e0ddf7 !important;
    }
    ...
    .darkmode .float-label .form-control-label {
        color: #ffffff;
    }

    .darkmode .float-label .form-control {
        color: #ffffff;
        border-color: rgba(255, 255, 255, 0.5);
    }

    .darkmode .float-label .form-control:focus {
        border-color: rgba(255, 255, 255, 0.9);
    }

    .darkmode .float-label select option {
        background: #222222;
    }
    ...
    .rtl.menu-overlay .main-menu {
        left: auto;
        right: -290px;
    }

    .rtl.menu-overlay.menu-open .main-menu {
        left: auto;
        right: 0;
    }

    .rtl.menu-overlay .main-menu .menu-container .nav-pills {
        padding: 0;
    }

    .rtl.menu-overlay .main-menu .menu-container .nav-pills .nav-item .nav-link .arrow {
        right: auto;
        left: 10px;
    }

    .rtl.menu-overlay .main-menu .menu-container .nav-pills .nav-item .nav-link .icon {
        margin-right: 0;
        margin-left: 10px;
    }
