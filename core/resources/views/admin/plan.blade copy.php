            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="table-responsive--sm">
                        <table id="TableBlock" class="table table--light style--two">
                            <thead id="tableHead">
                                <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control has-append" name="price"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="daily_limit" placeholder="@lang('Daily Ad Limit')"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="ads_rate">@lang('Per Ads Rate')</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="ads_rate" placeholder="@lang('Per Ads Rate')"
                                    required>
                                <div class="input-group-text">{{ $general->cur_text }}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="validity" placeholder="@lang('Validity')"
                                    required>
