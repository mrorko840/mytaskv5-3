                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-md-0 mb-4">
                                                        <div class="col-md-6 px-1">
                                                            <input name="wallet_address_lab" class="form-control" type="text" value="{{ old('wallet_address_lab') }}" placeholder="@lang('Field Name')">
                                                        </div>

                                                        <div class="col-md-6 px-1">
                                                            <input name="wallet_address" class="form-control" type="text" value="{{ old('wallet_address') }}" placeholder="@lang('Number/Wallet Address')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> 
